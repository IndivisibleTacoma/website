...
namespace TheBootstrapMachine.Handlers {
    public class BootstrapSettingsPartHandler : ContentHandler {
        public BootstrapSettingsPartHandler() {
            ...
            Filters.Add(new TemplateFilterForPart<BootstrapSettingsPart>("BootstrapSettings", "Parts/BootstrapSettings", "Style Overrides"));
        }
        ...
        protected override void GetItemMetadata(GetContentItemMetadataContext context) {
            ...
            context.Metadata.EditorGroupInfo.Add(new GroupInfo(T("Style Overrides")));
        }
    }
}